...
CREATE TABLE `carrental` (
  ...
  CONSTRAINT `carrental_ibfk_1` FOREIGN KEY (`customerid`) REFERENCES `customer` (`id`),
  CONSTRAINT `carrental_ibfk_2` FOREIGN KEY (`vehicleid`) REFERENCES `vehicle` (`id`),
  CONSTRAINT `carrental_ibfk_3` FOREIGN KEY (`invoiceid`) REFERENCES `invoice` (`id`)
