...
public class Login {
    ...
    public String con = "jdbc:mysql://localhost:3306/?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";

    public boolean register(String newEmail) {
        try {
            Connection connection = DriverManager.getConnection(con, "root", "root");
